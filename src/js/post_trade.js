  ...
  findIsin: function (event) {
    ...
    web3.eth.getAccounts(function (error, accounts) {
      ...
      App.contracts.PostTrade.deployed().then(function (instance) {
        ...
        return PostTradeInstance.getSecuritiesListLength({from: account
        });
        ...
        for (i = 0; i < result; i++) {
          // GET ISIN Names
          PostTradeInstance.getSecuritiesListById(i, {from: account
          }).then(function(_isin){
            console.log("ISIN Name: " + _isin[0]);
            // GET ISIN Details and build the table
            PostTradeInstance.getSecurityDetails(_isin[0], {from: account
